...
public class TwelfServer {
    ...
    private TwelfServer(Project project, Process process, CompileContext context) {
        ...
        this.future = ApplicationManager.getApplication().executeOnPooledThread(new TwelfOutputParser(project, process, context));
    }
...
class TwelfOutputParser implements Runnable {
