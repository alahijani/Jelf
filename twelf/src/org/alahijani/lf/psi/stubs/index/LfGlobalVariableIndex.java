...
public class LfGlobalVariableIndex extends StringStubIndexExtension<LfGlobalVariable> {
    ...
    public static Collection<LfGlobalVariable> getLfGlobalVariables(String name, GlobalSearchScope scope) {
        return StubIndex.getInstance().get(KEY, name, scope.getProject(), scope);
    }
